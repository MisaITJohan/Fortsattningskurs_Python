...
def greet_user():
    ...
    if name:
        ...
        greeting_label.config(text="Vänligen skriv ditt namn!")

# Label för instruktioner till användaren
instruction_label = tk.Label(root, text="Vänligen skriv ditt namn:")
...
greet_button = tk.Button(root, text="Hälsa på mig!", command=greet_user)
