...
#   namnet tk. Antagligen för att tydliggöra att det är Tk-verktygen man
#   använder.
...
# Med hjälp av metoder på fönstret (Tk-objektet) så kan vi ändra på egenskaper
#   hos vårt fönster.
...
# Storleken skickas, förvirrande nog, so men sträng. I dess simplaste form är
#   strängen "BREDDxHÖJD".
