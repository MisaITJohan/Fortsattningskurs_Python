...
def button_clicked():
    ...
    counter += 1
    result_label.config(
        text=f"Du har tryckt på knappen {counter} gång"
...
# parenteser efter button_clicked då funktionen inte ska köras när knappen
# skapas.
button = tk.Button(
    root,
    text="Klicka på mig!",
...
result_label = tk.Label(
    root,
    text="Du har tryckt på knappen 0 gånger!",
    )
