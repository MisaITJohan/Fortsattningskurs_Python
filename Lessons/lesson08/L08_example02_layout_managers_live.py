...
# För att våra Labels ska synas måste vi använda en av de tre Layouthanterarna
#   för att placera dem i vårt fönster.
# De tre fungerar på olika sätt, men alla kan ta emot vissa regler för hur
#   saker ska sättas ut. Dessa hanteras vi argument när man anropar metoden.

# .pack() lägger in Widgets enligt angivna regler, per standard så hamnar allt
#   i en enda lång kolumn. Argumenten padx och pady ger oss utrymme runt
#   Widgeten.
# label1.pack(pady=20)
