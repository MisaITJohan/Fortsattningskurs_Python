...
my_square_dict = {x:x**2 for x in range(10)}
print(my_square_dict)

numbers_to_combine = [[1, 2], [3, 4], [5, 6]]
my_combined_numbers_dict = {x[0]:x[1] for x in numbers_to_combine}
print(my_combined_numbers_dict)

number_list1 = [1, 2, 3]
number_list2 = [4, 5, 6]

my_combined_numbers_dict2 = {x:y for x, y in zip(number_list1, number_list2)}
print(my_combined_numbers_dict2)
