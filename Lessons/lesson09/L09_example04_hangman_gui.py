# Denna fil är en kopia av L08_example07_hangman_gui.py och används för
# att demonstrera hur man skriver en komplett testsvit i L09_example04_test_hangman.py.
# Notera: Exakt hela den filen är AI-genererad, jag har inte ändrat ett enda tecken.
...
class HangmanGameGUI:
    ...
    def update_word_display(self):
        ...
        # If the game is over and we lost, show the full word
        if self.game_finished and self.incorrect_guesses_made >= self.allowed_guesses:
            display = self.word_to_guess
        else:
            # Otherwise, create a display with underscores for unguessed letters
