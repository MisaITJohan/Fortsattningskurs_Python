...
#   innanför måsvingarna. Det ser ofta inte lika snyggt ut men kan användas på
#   flera olika sätt.
...
# Det gäller att tänka på exakt hur man skriver när man håller på med
#   f-strängar.
print(f"{1+1=}")
print(f"{1+1 = }")
print(f"{1 + 1= }")
# Notera skillnaden i det som skrivs ut. Mellanslagen so mman lägger in
#   innanför måsvingarna följer med när utskriften sker. Ibland vill man att
#   det ska vara mellanrum, ibland inte. Det gäller att tänka på hur man vill
#   att det ska se ut.

print(f"{"----" * 4}")


# Följande skulle kunna vara ett fall där man faktiskt vill använda sig av
#   detta med likamedtecken-syntaxen även i "vanligt" bruk och inte bara
#   i felskökning.
x = 42
y = 84
print(f"{x = }\n{y = }\n{x + y = }")
...
#   något som kunde se ett exemel på under förra workshoppen, hur or-klausuler
